...
Developer Relations Engineer and AI agent builder focused on agentic infrastructure, developer tooling, and making AI systems accessible to technical audiences. I'm also a speaker, technical content creator, and educator. I build things that help developers go from zero to working in minutes — SDKs, reference implementations, integrations, and the documentation that ties it all together.
